...
namespace xgame{
	...
	public:
		...
		/*! Inserisce una MemoryPage all'interno del pacchetto di pagine.
			...
			NOTABENE: la pagina di memoria di input verrà SPOSTATA all'interno del pacchetto.
				In poche parole non verrà fatta una copia dell'ingresso, ma la pagina di memoria di ingresso verrà invalidata
				e spostata all'interno del pacchetto di pagine.
		...
		*/
		...
		/*! Accede alla pagina di memoria all'interno del pacchetto con un determinato nome di riferimento.
			NOTA BENE: Se non esiste alcuna pagina di memoria con quel nome, verrà lanciata un'eccezione!
		*/
